        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Đơn xin nghỉ phép mới</h5>
                </div>
                <div class="page-title-right d-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Tạo đơn xin nghỉ phép mới</li>
                    </ol>
                </div>
            </div>
            <!-- /.page-title -->
            ...
            ?>
            <?php
            $parament = $data["next_IdForm"];
            $link = '/create/leave_day_form/' . $parament;
            ?>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input class="form-control" placeholder="Form ID"
                                                       ...
                                                       value="<?php echo htmlspecialchars($data["next_IdForm"]); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
