...
<head>
    ...
    <title>Sửa đơn xin nghỉ phép</title>
    <!-- CSS -->
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Sửa đơn xin nghỉ phép</h5>
                </div>
            </div>
            <!-- /.page-title -->
            <!-- =================================== -->
            ...
            $parament = $arr[2];
            $link4 = '/edit/department_leave_day_form/' . $parament;
            ?>
                        ...
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <form action="<?php echo $link4 ?>" method="POST">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" readonly="readonly" name="IdAccount"
                                                   ...
                                                   value="<?php echo htmlspecialchars($data["default"]["IdAccount_Employess"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">ID Đơn</label>
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input class="form-control" placeholder="Form ID"
                                                       type="number" maxlength="10" name="IdForm" readonly="readonly"
                                                       value="<?php echo htmlspecialchars($data["default"]["IdForm"]); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l13">Ngày bắt đầu</label>
                                        <div class="col-md-9">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                            class="list-icon material-icons">date_range</i></span>
                                                <input type="text" class="form-control datepicker" name="Start_Date"
                                                       placeholder="Start Date"
                                                       value="<?php echo htmlspecialchars(date('m/d/Y', strtotime($data["default"]["Start_Date"]))); ?>"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l13">Ngày kết thúc</label>
                                        <div class="col-md-9">
                                            <div class="input-group"><span class="input-group-addon"><i
                                                            class="material-icons list-icon">date_range</i> </span>
                                                <input type="text" class="form-control datepicker" name="End_Date"
                                                       placeholder="End Date"
                                                       value="<?php echo htmlspecialchars(date('m/d/Y', strtotime($data["default"]["End_Date"]))); ?>"
                                                       data-plugin-options='{"autoclose": true}'>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l15">Lý do</label>
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="Reason" placeholder="Reason"
                                                      rows="3"><?php echo htmlspecialchars($data["default"]["Reason"]); ?></textarea>
                                        </div>
                                    </div>
