        ...
        <div class="main-wrapper clearfix">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg bg-primary text-inverse">
                        <div class="widget-body">
                            <div class="widget-counter">
                                <h6>Tổng số đơn xin nghỉ phép trong phòng ban quản lý <small
                                            class="text-inverse"></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["total_amount"]); ?></span>
                                </h3><i
                                        class="material-icons list-icon">event_note</i>
                            </div>
                            <!-- /.widget-counter -->
                        </div>
                        <!-- /.widget-body -->
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg bg-color-scheme text-inverse">
                        <div class="widget-body clearfix">
                            <div class="widget-counter">
                                <h6>Số đơn nghỉ phép đã duyệt <small class="text-inverse"></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["approve_amount"]); ?></span>
                                </h3><i class="material-icons list-icon">event_available</i>
                            </div>
                            <!-- /.widget-counter -->
                        </div>
                ...
                <div class="col-md-4 col-6 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <div class="widget-counter">
                                <h6>Số đơn nghỉ phép đang chờ duyệt <small></small></h6>
                                <h3 class="h1"><span
                                            class="counter"><?php echo htmlspecialchars($data["pending_amount"]); ?></span>
                                </h3><i class="material-icons list-icon">event_busy</i>
                            </div>
                            <!-- /.widget-counter -->
                        </div>
                        <!-- /.widget-body -->
            ...
            <div class="row">
                <div class="col-md-12 widget-holder">
                    <div class="widget-bg">
                        <div class="widget-body clearfix">
                            <h5 class="box-title">Danh sách đơn xin nghỉ phép của phòng ban quản lý</h5>
                            <div class="padded-reverse">
                                <table class="table table-striped widget-status-table mr-b-0">
                                    <thead>
                                    <tr>
                                    ...
                                    <?php
                                    $result = $data["department_list_form"];
                                    foreach ($result as $key => $value) {
                                        $parament = $value['IdForm'];
