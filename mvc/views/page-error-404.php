...
<body class="body-bg-full error-page error-404" style="background-image: url(/public/assets/demo/body-bg.jpg)">;
<div id="wrapper" class="wrapper">
    <div class="content-wrapper">
        <main class="main-wrapper">
            ...
            <p class="mr-t-10 mr-b-20">Cái này mình chưa nghĩ ra nên tạm thời để 404 :D</p><a
                    href="javascript: history.back();" class="btn btn-info btn-lg btn-rounded mr-b-20 ripple">Quay
                lại</a>
        </main>
    </div>
    <!-- .content-wrapper -->
