...
<body class="body-bg-full error-page error-500" style="background-image: url(/public/assets/demo/body-bg.jpg)">;
<div id="wrapper" class="wrapper">
    <div class="content-wrapper">
        <main class="main-wrapper">
            ...
            <p class="mr-t-10 mr-b-20">Cái này là lỗi code rồi :( Chắc quên ; ở đâu đó...</p><a
