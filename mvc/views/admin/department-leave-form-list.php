...
<head>
    ...
    <title>Danh sách đơn xin nghỉ phép theo phòng ban</title>
    <!-- CSS -->
            ...
            <div class="row page-title clearfix">
                ...
                <div class="page-title-right d-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Danh sách đơn xin nghỉ phép</a>
                        </li>
                        <li class="breadcrumb-item active"><?php if (intval($data["dept_num"]) === 1) {
                                echo "Phòng An toàn ứng dụng";
                            } else if (intval($data["dept_num"]) === 2) {
                                echo "Phòng Kinh doanh";
                            } else if (intval($data["dept_num"]) === 3) {
                                echo "Phòng Phân tích mã độc";
                            } else if (intval($data["dept_num"]) === 4) {
                                echo "Phòng Nhân sự";
                            } ?></li>
                    </ol>
                </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>Danh sách đơn xin nghỉ phép</h5>
                            </div>
                            <!-- /.widget-heading -->
                            <div class="widget-body clearfix">
                                <table class="table table-editable" data-toggle="datatables">
                                    ...
                                    foreach ($result as $key => $value) {
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo htmlspecialchars($value['Employess_Code']); ?></td>
                                            ...
                                            <td><?php if ($value['Form_Status'] === "Approved") {
                                                    echo "Đã phê duyệt";
                                                } else echo "Đang chờ phê duyệt"; ?></td>
                                            <td style="white-space: nowrap; width: 1%;">
                                                <div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                                    <div class="btn-group btn-group-sm" style="float: none;">
                                                        <a href="<?php echo $link6; ?>" button type="button"
                                                           class="tabledit-edit-button btn btn-sm btn-default"
                                                           style="float: none;"><span
                                                                    class="glyphicon"><i
                                                                        class="list-icon material-icons">done</i></span></a>
                                                        <a href="<?php echo $link4; ?>" button type="button"
                                                           class="tabledit-edit-button btn btn-sm btn-default"
                                                           style="float: none;"><span
                                                                    class="glyphicon glyphicon-pencil"></span></a>
                                                        <a href="<?php echo $link5; ?>" button type="button"
                                                           class="tabledit-edit-button btn btn-sm btn-default"
                                                           style="float: none;"><span
