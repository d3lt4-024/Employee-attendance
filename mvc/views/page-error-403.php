...
<body class="body-bg-full error-page error-403" style="background-image: url(/public/assets/demo/body-bg.jpg)">;
<div id="wrapper" class="wrapper">
    <div class="content-wrapper">
        <main class="main-wrapper">
            ...
            <h4>Access Denied!</h4>
            <p class="mr-t-10 mr-b-20">Đừng hack bạn ơi :( Đừng hack :(</p><a href="javascript: history.back();"
                                                                              class="btn btn-info btn-lg btn-rounded mr-b-20 ripple">Quay
                lại</a>
        </main>
    </div>
    <!-- .content-wrapper -->
